...
from configs.go2 import go2, go2PPO
...
def play(args):
    ...
    '/home/jiaojunpeng/isaac/LocomotionWithNP3O-masterV5/LocomotionWithNP3O-master/logs/rough_go2_constraint/Jan06_16-05-55_test_barlowtwins/model_4000.pt'))#《---------------------调用的网络模型doghome
